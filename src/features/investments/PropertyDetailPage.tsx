...
export default function PropertyDetailPage() {
  ...
  async function handleOpenDoc(path: string) {
    try {
      ...
      // signed-URL generation failed (expired session, network) — no-op, user can retry
    }
  }

  return (
    <>
      <button className="back-link" onClick={() => navigate('/investments')} type="button">
        ← Back to Investments
      </button>
      ...
      <div className="detail-grid">
        ...
        <div className="card">
          ...
          <div className="photo-grid">
            ...
            <button className="btn-outline" style={{ width: '100%', marginTop: 12 }} onClick={() => navigate(`/investments/${p.id}/photos`)}>
              VIEW ALL PHOTOS
            </button>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="doc-list">
            ...
            <button className="btn-outline" style={{ width: '100%', marginTop: 12 }} onClick={() => navigate(`/investments/${p.id}/documents`)}>
              VIEW ALL DOCUMENTS
            </button>
          </div>
        </div>
      ...
      <div className="card" style={{ marginTop: 22 }}>
        ...
        <div className="doc-list">
          ...
          <button className="btn-outline" style={{ width: '100%', marginTop: 12 }} onClick={() => navigate(`/investments/${p.id}/tenants`)}>
            VIEW TENANTS
          </button>
        </div>
      </div>
